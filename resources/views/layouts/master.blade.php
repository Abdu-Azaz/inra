                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class=" dropend m-0 py-2">
                                ...
                                <ul class="dropdown-menu">
                                    @for ($i = 1; $i < 4; $i++)
                                        <li><a class="dropdown-item"
                                                href="{{ route('methodologies.axe', ['axe' => 'axe' . $i]) }}">Axe
                                                {{ $i }}</a>
                                        </li>
                                    @endfor
                                </ul>
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class=" dropend m-0 py-2">
                                ...
                                <ul class="dropdown-menu">
                                    @for ($i = 1; $i < 4; $i++)
                                        <li><a class="dropdown-item"
                                                href="{{ route('resultats.axe', ['axe' => 'axe' . $i]) }}">Axe
                                                {{ $i }}</a></li>
                                    @endfor
                                </ul>
                            </li>
                        ...
                        <div class="row gx-5">
                            <div class="col-lg-12 col-md-12 pt-5 mb-5 d-flex flex-column align-items-center">
                                ...
                                <div class="d-flex mb-2">
                                    ...
                                    <p class="mb-0">B.P. 124 Inezgane - Agadir Maroc</p>
                                </div>
                                <div class="d-flex mb-2">
                                ...
                                <div class="d-flex mb-2">
                                    ...
                                    <p class="mb-0">+212 528240326 / +212 528240801</p>
                                </div>
                    ...
                    <div class="col-lg-6">
                        <div
                            ...
                            <a href="index.html" class="navbar-brand">
                                <h3 class="m-0 text-white"><i class="fa fa-user-tie me-2"></i>Convention de droit
                                    commun</h3>
                            </a>
